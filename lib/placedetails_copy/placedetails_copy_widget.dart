...
export 'placedetails_copy_model.dart';
...
class _PlacedetailsCopyWidgetState extends State<PlacedetailsCopyWidget> {
  late PlacedetailsCopyModel _model;
                                  ...
                                  child: Container(
                                    ...
                                    child: Stack(
                                      children: [
                                        Align(
                                          alignment:
                                              AlignmentDirectional(0.17, -0.98),
                                          child: Padding(
                                            padding:
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              _model.myMapEvent =
                                                ...
                                                loginId: widget.sessionID,
                                                sessionId: widget.sessionID,
                                                location: widget.currentCord,
                                                regionalTime: dateTimeFormat(
                                                  'yMMMd',
                                                  getCurrentTimestamp,
                                              ...
                                              if ((_model
                                                      .myMapEvent?.succeeded ??
                                                  true)) {
                                                ScaffoldMessenger.of(context)
                                                    .showSnackBar(
                                                  SnackBar(
                                                    content: Text(
                                                      'Data saved successfully, Please wait for 1hour before data is populated',
                                                      style: TextStyle(
                                                        color:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                        ...
                                        Align(
                                          alignment:
                                              AlignmentDirectional(0.06, -0.73),
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    10.0, 5.0, 10.0, 0.0),
                                                      ...
                                                      decoration:
                                                        ...
                                                        labelText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          '36ozdfor' /* Select Category (required) */,
                                                        ),
                                                        labelStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
