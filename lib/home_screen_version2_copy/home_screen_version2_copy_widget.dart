...
import 'home_screen_version2_copy_model.dart';
...
class _HomeScreenVersion2CopyWidgetState
    extends State<HomeScreenVersion2CopyWidget> {
  late HomeScreenVersion2CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeScreenVersion2CopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final homeScreenVersion2CopyLinkBageLoginResponse = snapshot.data!;
                                                    ...
                                                    FlutterFlowRadioButton(
                                                      options: [
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'tmezntb8' /* Current Location */,
                                                        ),
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'q7jbzx15' /* Select Location */,
                                                        )
                                                      ].toList(),
                                                      onChanged: (val) async {
                                                        setState(() {});
                                                            ...
                                                            decoration:
                                                              ...
                                                              hintText:
                                                                  FFLocalizations.of(
                                                                          context)
                                                                      .getText(
                                                                'e3srnczy' /* Search  e.g School, Park */,
                                                              ),
                                                              hintStyle:
                                                                  FlutterFlowTheme.of(
                                                                          context)
