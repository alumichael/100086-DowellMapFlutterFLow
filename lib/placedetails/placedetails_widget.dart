...
class _PlacedetailsWidgetState extends State<PlacedetailsWidget> {
  ...
  void initState() {
    ...
    _model.textController3 ??= TextEditingController(text: widget.currentCord);
                                              ...
                                              Align(
                                                ...
                                                child:
                                                  ...
                                                  options: [
                                                    ...
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '3r26th6i' /* Hotels & Lodging */,
                                                    ),
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      're1ggb2o' /* Outdoors & Recreation */,
                                                    ),
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '3stuqep4' /* Religion */,
                                                  ...
                                                  hintText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    't35z80vj' /* category (required) */,
                                                  ),
                                                  searchHintText:
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                    'amp934hx' /* Search for an item... */,
                                                  ),
                                                  fillColor:
                                                      FlutterFlowTheme.of(
                                                              context)
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          _model.addMyMap =
                                            ...
                                            locationCord: widget.currentCord,
                                            dayHours:
                                                _model.textController4.text,
                                            phone: _model.textController5.text,
                                            hours: _model.textController4.text,
                                            typeOfData: 'Data type',
                                            website: 'webbsite',
                                            eventId: CreateEventCall.eventID(
                                              (_model.myMapEvent?.jsonBody ??
                                                  ''),
                                            ).toString(),
                                            country:
                                                _model.textController6.text,
                                          );
                                          if (MymapCall.isSuccessful(
                                            (_model.addMyMap?.jsonBody ?? ''),
                                          )) {
