...
class _PlacedetailsWidgetState extends State<PlacedetailsWidget> {
  ...
  void initState() {
    ...
    _model.websiteEdtController1 ??= TextEditingController();
    _model.websiteEdtFocusNode1 ??= FocusNode();

    _model.placeNameEdtController ??= TextEditingController();
    _model.placeNameEdtFocusNode ??= FocusNode();

    _model.selectedLocationEdtController ??=
        TextEditingController(text: FFAppState().selectedLocation);
    _model.selectedLocationEdtFocusNode ??= FocusNode();

    _model.websiteEdtController2 ??= TextEditingController();
    _model.websiteEdtFocusNode2 ??= FocusNode();
                                            ...
                                            Align(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: TextFormField(
                                                    controller: _model
                                                        .openHoursEdtController,
                                                    focusNode: _model
                                                        .openHoursEdtFocusNode,
                                                    autofocus: true,
                                                    obscureText: false,
                                                    decoration: InputDecoration(
                                                      labelText:
                                            ...
                                            Align(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: TextFormField(
                                                    controller: _model
                                                        .phonrNumEdtController,
                                                    focusNode: _model
                                                        .phonrNumEdtFocusNode,
                                                    autofocus: true,
                                                    obscureText: false,
                                                    decoration: InputDecoration(
                                                      labelText:
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                  ...
                                                  if ((_model
                                                    ...
                                                    if ((_model.myMapEvent
                                                            ?.succeeded ??
                                                        true)) {
                                                      _model.addMyMap =
                                                          await MymapCall.call(
                                                        placeName: _model
                                                            .placeNameEdtController
                                                            .text,
                                                        category: _model
                                                      ...
                                                      if ((_model.addMyMap
                                                        ...
                                                        ScaffoldMessenger.of(
                                                          ...
                                                          SnackBar(
                                                            content: Text(
                                                              'Data saved successfully, Please wait for 1 hour before data is populated',
                                                              style: TextStyle(
                                                                color: FlutterFlowTheme.of(
                                                                        context)
                                                                    .primaryText,
                                            ...
                                            Align(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: TextFormField(
                                                    controller: _model
                                                        .websiteEdtController1,
                                                    focusNode: _model
                                                        .websiteEdtFocusNode1,
                                                    autofocus: true,
                                                    obscureText: false,
                                                    decoration: InputDecoration(
                                                      labelStyle:
                                            ...
                                            Align(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: TextFormField(
                                                    controller: _model
                                                        .websiteEdtController2,
                                                    focusNode: _model
                                                        .websiteEdtFocusNode2,
                                                    autofocus: true,
                                                    obscureText: false,
                                                    decoration: InputDecoration(
                                                      labelText:
                                            ...
                                            Align(
                                              ...
                                              child:
                                                ...
                                                options: [
                                                  ...
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'dkrg1boa' /* Hotels & Lodging */,
                                                  ),
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'me2oyhk6' /* Outdoors & Recreation */,
                                                  ),
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '8xo5vqar' /* Religion */,
