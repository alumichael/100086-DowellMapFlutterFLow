...
class _TrackingDetailsFormWidgetState extends State<TrackingDetailsFormWidget> {
  late TrackingDetailsFormModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrackingDetailsFormModel());
    ...
    _model.companyNameextFieldController ??= TextEditingController();
    _model.companyNameextFieldFocusNode ??= FocusNode();

    _model.countryTextFieldController ??= TextEditingController();
    _model.countryTextFieldFocusNode ??= FocusNode();
