...
class _ButtomSheetWidgetState extends State<ButtomSheetWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ButtomSheetModel());
                    ...
                    FlutterFlowRadioButton(
                      options: [
                        FFLocalizations.of(context).getText(
                          '0rdfxr3p' /* Current  Location */,
                        ),
                        FFLocalizations.of(context).getText(
                          'qqyi3agc' /* Select  Location */,
                        )
                      ].toList(),
                      onChanged: (val) async {
                        setState(() {});
                          ...
                          if ((_model.nearbyPlaceResponse?.succeeded ?? true)) {
                            if (functions
                              ...
                              if ((_model.evenntID?.succeeded ?? true)) {
                                ...
                                _model.logResponse = await SendLogDataCall.call(
                                  mongoID: random_data.randomString(
                                    1,
                                    10,
                                    true,
                                    false,
                                  ...
                                  reqID: random_data.randomString(
                                    1,
                                    10,
                                    true,
                                    false,
                                  ...
                                  userName: random_data.randomName(true, false),
                                  sessionId: FFAppState().sessionId,
                                  locationDone: functions.latlngToString(
                                      FFAppState().currentLocation ==
                                              'Current Location'
                                          ? currentUserLocationValue!
                                          : _model.placePickerValue.latLng),
