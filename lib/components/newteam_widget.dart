                      ...
                      Align(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            if ((_model.createTeamResponse?.succeeded ??
                                true)) {
                              FFAppState().update(() {
                                FFAppState()
                                    .addToTeamList(_model.textController.text);
                              });
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    'Succesfully create team  ${_model.textController.text}',
                                    style: TextStyle(
