...
export 'add_member_screen_model.dart';

class AddMemberScreenWidget extends StatefulWidget {
  const AddMemberScreenWidget({super.key});

  @override
  State<AddMemberScreenWidget> createState() => _AddMemberScreenWidgetState();
}

class _AddMemberScreenWidgetState extends State<AddMemberScreenWidget> {
  late AddMemberScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddMemberScreenModel());
                                            ...
                                            return Column(
                                              ...
                                              children: List.generate(
                                                ...
                                                return NewMemberBoxWidget(
                                                  key: Key(
                                                      'Key2vg_${membersBuilderIndex}_of_${membersBuilder.length}'),
                                          ...
                                          builder: (context) {
                                            ...
                                            return Column(
                                              ...
                                              children: List.generate(
                                                ...
                                                return NewMemberBoxWidget(
                                                  key: Key(
                                                      'Keyb99_${guestMembersBuilderIndex}_of_${guestMembersBuilder.length}'),
                                                  itemInfo:
